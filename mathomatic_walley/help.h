...
#endif
#if	!SECURE
{	"read",		NULL,			read_cmd,		"[file-name or directory]",				"Display/change directory, or read in a text file as if it was typed in.", "This command may be preceded with \"repeat\"." },
#endif
...
char	*geometry_strings[] = {
	...
	"; sum of all interior angles formula in degree and radian units:\n",
	...
	"; Type \"eliminate sides\" to get the radians/degrees conversion formula.\n",
	NULL
};
